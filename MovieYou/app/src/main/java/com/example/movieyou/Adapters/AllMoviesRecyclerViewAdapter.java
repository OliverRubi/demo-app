...
public class AllMoviesRecyclerViewAdapter extends RecyclerView.Adapter<AllMoviesRecyclerViewAdapter.MyViewHolder> {
    private static final String TAG = "AllMoviesRecyclerViewAd";
    private Context context;
    private ArrayList<Movie> movies;

    public AllMoviesRecyclerViewAdapter(Context context, ArrayList<Movie> movies) {
